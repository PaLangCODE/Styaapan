    ...
    <div className="flex justify-center">
      <div className="px-4" style={{ maxWidth: '1600px' }}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4 " >
          {
            nfts.map((nft, i) => (
              <div key={i} className="border shadow rounded-xl overflow-hidden bg-blue-200">
                <img style={{ objectFit: "fit", height: 300 }} src={nft.image} height={300} width={400} alt={nft.name} />
                <div className="p-4">
                ...
                </div>}
                {
                  ...
                  <div className="p-4 bg-sky-500">
                    <button className="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-12 rounded" onClick={() => { setTransferSelected(i) }}>TRANSFER </button>
                  </div>
                }
              </div>
            ))
